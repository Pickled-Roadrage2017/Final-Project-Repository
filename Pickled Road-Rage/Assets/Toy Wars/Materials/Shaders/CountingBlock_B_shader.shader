...
////// Specular:
                ...
                float3 diffuseColor = lerp(lerp(float3(1,0.2329693,0.2329693),float3(0.3897059,0.1146194,0.1146194),_node_5595_var.g),float3(1,1,1),_node_8868_var.b); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _node_5595_var = tex2D(_node_5595,TRANSFORM_TEX(i.uv0, _node_5595));
                float4 _node_8868_var = tex2D(_node_8868,TRANSFORM_TEX(i.uv0, _node_8868));
                float3 diffColor = lerp(lerp(float3(1,0.2329693,0.2329693),float3(0.3897059,0.1146194,0.1146194),_node_5595_var.g),float3(1,1,1),_node_8868_var.b);
                float specularMonochrome;
                float3 specColor;
                float4 _node_9346_var = tex2D(_node_9346,TRANSFORM_TEX(i.uv0, _node_9346));
