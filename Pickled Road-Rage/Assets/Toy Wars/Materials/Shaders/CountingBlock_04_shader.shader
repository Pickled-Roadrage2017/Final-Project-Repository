...
////// Specular:
                ...
                float3 diffuseColor = lerp(lerp(float3(0.07665782,0.01486807,0.4044118),float3(0.1123729,0.03703501,1),_node_1803_var.g),float3(1,1,1),_node_7167_var.a); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _node_1803_var = tex2D(_node_1803,TRANSFORM_TEX(i.uv0, _node_1803));
                float4 _node_7167_var = tex2D(_node_7167,TRANSFORM_TEX(i.uv0, _node_7167));
                float3 diffColor = lerp(lerp(float3(0.07665782,0.01486807,0.4044118),float3(0.1123729,0.03703501,1),_node_1803_var.g),float3(1,1,1),_node_7167_var.a);
                float specularMonochrome;
                float3 specColor;
                float4 _node_7631_var = tex2D(_node_7631,TRANSFORM_TEX(i.uv0, _node_7631));
