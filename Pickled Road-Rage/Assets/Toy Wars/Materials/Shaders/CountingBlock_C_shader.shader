...
////// Specular:
                ...
                float3 diffuseColor = lerp(lerp(float3(1,0.2329693,0.2329693),float3(0.3897059,0.1146194,0.1146194),_node_6549_var.g),float3(1,1,1),_node_1330_var.a); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _node_6549_var = tex2D(_node_6549,TRANSFORM_TEX(i.uv0, _node_6549));
                float4 _node_1330_var = tex2D(_node_1330,TRANSFORM_TEX(i.uv0, _node_1330));
                float3 diffColor = lerp(lerp(float3(1,0.2329693,0.2329693),float3(0.3897059,0.1146194,0.1146194),_node_6549_var.g),float3(1,1,1),_node_1330_var.a);
                float specularMonochrome;
                float3 specColor;
                float4 _node_8854_var = tex2D(_node_8854,TRANSFORM_TEX(i.uv0, _node_8854));
