...
////// Specular:
                ...
                float3 diffuseColor = lerp(lerp(float3(1,0.2329693,0.2329693),float3(0.3897059,0.1146194,0.1146194),_node_7606_var.g),float3(1,1,1),_node_1520_var.r); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _node_7606_var = tex2D(_node_7606,TRANSFORM_TEX(i.uv0, _node_7606));
                float4 _node_1520_var = tex2D(_node_1520,TRANSFORM_TEX(i.uv0, _node_1520));
                float3 diffColor = lerp(lerp(float3(1,0.2329693,0.2329693),float3(0.3897059,0.1146194,0.1146194),_node_7606_var.g),float3(1,1,1),_node_1520_var.r);
                float specularMonochrome;
                float3 specColor;
                float4 _node_1561_var = tex2D(_node_1561,TRANSFORM_TEX(i.uv0, _node_1561));
