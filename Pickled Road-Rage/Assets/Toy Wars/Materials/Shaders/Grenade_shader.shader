...
Shader "Shader Forge/Grenade_shader" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_775; uniform float4 _node_775_ST;
            uniform sampler2D _node_7229; uniform float4 _node_7229_ST;
            struct VertexInput {
                float4 vertex : POSITION;
                float3 normal : NORMAL;
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 viewDirection = normalize(_WorldSpaceCameraPos.xyz - i.posWorld.xyz);
                float3 _node_608_var = UnpackNormal(tex2D(_node_608,TRANSFORM_TEX(i.uv0, _node_608)));
                float3 _node_775_var = UnpackNormal(tex2D(_node_775,TRANSFORM_TEX(i.uv0, _node_775)));
                float4 _node_7229_var = tex2D(_node_7229,TRANSFORM_TEX(i.uv0, _node_7229));
                float3 normalLocal = lerp(_node_608_var.rgb,_node_775_var.rgb,_node_7229_var.r);
...
///////// Gloss:
                float gloss = _node_7229_var.a;
                float perceptualRoughness = 1.0 - _node_7229_var.a;
...
////// Specular:
                ...
                float3 specularColor = _node_7229_var.r;
...
/////// Diffuse:
                ...
                float4 _node_1213_var = tex2D(_node_1213,TRANSFORM_TEX(i.uv0, _node_1213));
                indirectDiffuse *= _node_1213_var.r; // Diffuse AO
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float3 specColor;
                float4 _node_7229_var = tex2D(_node_7229,TRANSFORM_TEX(i.uv0, _node_7229));
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, _node_7229_var.r, specColor, specularMonochrome );
                float roughness = 1.0 - _node_7229_var.a;
