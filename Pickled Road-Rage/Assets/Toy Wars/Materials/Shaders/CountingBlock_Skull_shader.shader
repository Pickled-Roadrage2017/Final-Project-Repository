...
////// Specular:
                ...
                float3 diffuseColor = lerp(lerp(float3(0.2593305,0.1985294,1),float3(0.07665782,0.01486807,0.4044118),_node_4720_var.g),float3(1,1,1),_node_4834_var.r); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _node_4720_var = tex2D(_node_4720,TRANSFORM_TEX(i.uv0, _node_4720));
                float4 _node_4834_var = tex2D(_node_4834,TRANSFORM_TEX(i.uv0, _node_4834));
                float3 diffColor = lerp(lerp(float3(0.2593305,0.1985294,1),float3(0.07665782,0.01486807,0.4044118),_node_4720_var.g),float3(1,1,1),_node_4834_var.r);
                float specularMonochrome;
                float3 specColor;
                float4 _node_3349_var = tex2D(_node_3349,TRANSFORM_TEX(i.uv0, _node_3349));
